<aside class="main-sidebar sidebar-dark-primary elevation-4" style="min-height: 917px;">
    ...
    <div class="sidebar">
       ...
       @can('vacation_request_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.vacation_requests.index") }}"
                           class="nav-link {{ request()->is('admin/vacation_requests') || request()->is('admin/vacation_requests/*') ? 'active' : '' }}">
                           <i class="fa-fw fas fa-calendar"></i>
                            <p>
                                <span>{{ trans('cruds.vacation_request.title') }}</span>
                            </p>
                        </a>
                    </li>
                @endcan
